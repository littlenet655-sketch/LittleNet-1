...
const styles = StyleSheet.create({
  ...
  brand: { fontSize: type.caption, fontWeight: '800', color: colors.brand, letterSpacing: 2, textTransform: 'uppercase' },
  ...
  button: { backgroundColor: colors.brand, borderRadius: radius.pill, paddingVertical: 14, alignItems: 'center', marginTop: spacing.sm },
  buttonSecondary: { backgroundColor: colors.surface, borderWidth: 2, borderColor: colors.brand },
  buttonDisabled: { opacity: 0.55 },
  buttonText: { color: '#fff', fontWeight: '800', fontSize: type.body },
  buttonTextSecondary: { color: colors.brandDark },
  field: { marginTop: spacing.sm },
  label: { fontSize: type.caption, fontWeight: '700', color: colors.ink, marginBottom: 4 },
  input: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, borderRadius: radius.md, paddingHorizontal: 14, paddingVertical: 12, fontSize: type.body, color: colors.ink },
