...
const styles = StyleSheet.create({
  ...
  metric: { flex: 1, minHeight: 76, padding: spacing.sm, borderRadius: radius.md, backgroundColor: '#E6F7F7', justifyContent: 'center' },
  metricAlert: { backgroundColor: '#FDECEC' },
  ...
  menuCard: { minHeight: 72, padding: spacing.md, borderWidth: 1, borderColor: colors.line, borderRadius: radius.lg, backgroundColor: colors.surface, justifyContent: 'center' },
  menuTitle: { color: colors.ink, fontSize: type.subtitle, fontWeight: '800' },
  childCard: { minHeight: 76, flexDirection: 'row', gap: spacing.sm, alignItems: 'center', backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, borderRadius: radius.lg, padding: spacing.md, marginBottom: spacing.sm },
  listCard: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, borderRadius: radius.lg, padding: spacing.md, marginBottom: spacing.sm },
  ...
  reviewImage: { width: '100%', height: 280, borderRadius: radius.md, backgroundColor: colors.line, marginVertical: spacing.sm },
