...
const styles = StyleSheet.create({
  ...
  metric: { flex: 1, minHeight: 80, padding: spacing.sm, borderRadius: radius.md, backgroundColor: '#E6F7F7', justifyContent: 'center' },
  alertMetric: { backgroundColor: '#FDECEC' },
  ...
  menu: { minHeight: 76, backgroundColor: colors.surface, borderRadius: radius.lg, borderWidth: 1, borderColor: colors.line, padding: spacing.md, marginBottom: spacing.sm, justifyContent: 'center' },
